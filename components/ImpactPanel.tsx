          ...
          <section>
            ...
            <p className="mt-1.5 text-[9.5px] leading-snug" style={{ color: "var(--ink-3)" }}>
              {rescue.origin === "mundaneum-live"
                ? "Ranked live by Mundaneum — an external open-source data aggregator indexing 40k+ datasets across Databricks, Snowflake, Kaggle, HF, Datarade…. The write-back below files these as a rescue proposal document in DataHub."
                : "A bundled snapshot of real results from Mundaneum — an external open-source data aggregator (in development) indexing 40k+ datasets across public and commercial catalogs. The write-back below files these as a rescue proposal document in DataHub."}
            </p>
          </section>
        )}
